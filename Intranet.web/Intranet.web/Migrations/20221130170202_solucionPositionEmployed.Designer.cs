...
namespace Intranet.web.Migrations
{
    ...
    [Migration("20221130170202_solucionPositionEmployed")]
    partial class solucionPositionEmployed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intranet.web.Data.Entities.Compras.SalaVenta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Intranet.web.Data.Entities.Employee", b =>
                {
                    ...
                    b.Property<string>("NumeroCtaAhorros")
                        .HasMaxLength(80);
            ...
            modelBuilder.Entity("Intranet.web.Data.Entities.Fidelizacion.TercBnet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Intranet.web.Data.Entities.Compras.Negociation", b =>
                {
                    ...
                    b.HasOne("Intranet.web.Data.Entities.Compras.SalaVenta", "SalaVenta")
                        .WithMany("Negociations")
                        .HasForeignKey("SalaVentaId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Intranet.web.Data.Entities.Exams", b =>
                {
                    ...
                    b.HasOne("Intranet.web.Data.Entities.PositionEmployee")
                        .WithMany("Exams")
                        .HasForeignKey("PositionEmployeeId");
                });
